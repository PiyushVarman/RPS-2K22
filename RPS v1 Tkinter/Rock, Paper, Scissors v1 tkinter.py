...
bg_image=PhotoImage(file="C://songs//from desktop//PCV//ICT and Python Classes//Python Classes//Class XI- Python Programs//Fun and Games//Rock Paper Scissors//bgimage (1).png")
def exitscreen():
    global attempts
    global rps
    global exitscrn
    ...
    perattemptscore=Label(exitscrn,text=pas,anchor='w',font=('Broadway',30,'bold italic'),fg='white',bg='#000123')
    ...
    if int(playscore-cpuscore)>0:
        ...
        result=Label(exitscrn,text="You lost! ",font=('Broadway',35,'bold italic'),fg='red',bg='#000123')
        result.place(x=610,y=410,anchor="center")
    else:
        result=Label(exitscrn,text="It's a Tie! ",font=('Broadway',35,'bold italic'),fg='white',bg='#000123')
        result.place(x=610,y=410,anchor="center")
...
def rock():
    ...
    cpulabel=Label(rps,text=cputext,font=('Calibri',14),bg='white')
    cpulabel.place(x=640,y=400,anchor='center')
    if play!=cpu:
        if cpu!='paper':
            resultlabel=Label(rps,text="You Won!",bg='white',font=('Calibri',14))
            resultlabel.place(x=640,y=425,anchor='center')
            playscore+=1
        else:
            resultlabel=Label(rps,text="The CPU Won!",bg='white',font=('Calibri',14))
            resultlabel.place(x=640,y=425,anchor='center')
            cpuscore+=1
    else:
        resultlabel=Label(rps,text="It's a tie!Equal points awarded!",bg='white',font=('Calibri',14))
        resultlabel.place(x=640,y=425,anchor='center')
        playscore+=1
        cpuscore+=1
